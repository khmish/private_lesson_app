...
class _OrderDetailState extends State<OrderDetail> {
  ...
  User myuser =
      new User(name: "", email: "", city: -1, phone: "", gender: "", id: -1);
  @override
  void initState() {
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            // *******************Rating **********************
                            myuser.role!.toLowerCase()=="student"? RatingInputWidget(
                            ...
                            //     icon: Icons.offline_pin_rounded),
                            if (widget.lesson.state!.toLowerCase() ==
                                "accepted")
                              ElevatedButton.icon(
                                  onPressed: () {
                                    Navigator.push(
